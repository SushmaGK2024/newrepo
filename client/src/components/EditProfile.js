...
const EditProfile = (props) => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await axios.get(`https://majorsssssss.onrender.com/users/profile/${id}`, {
          headers: {
  ...
  const handleSaveChanges = async (e) => {
    ...
    try {
      const response = await axios.put(`https://majorsssssss.onrender.com/users/profile/${id}`, updatedData, config);
