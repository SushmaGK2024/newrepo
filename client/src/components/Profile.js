...
const Profile = (props) => {
  ...
  console.log("currrollno in prof : ", props)
    ...
    useEffect(() => {
      if (!currrollno) {
        ...
        const fetchUserProfile = async () => {
          try {
            const response = await axios.get(`https://majorsssssss.onrender.com/users/profile/${currrollno}`);
    ...
    const handleDeleteExperience = async (experienceId) => {
      ...
      try {
        const response = await axios.delete(`https://majorsssssss.onrender.com/experiences/experiences/${experienceId}`, config);
  ...
  useEffect(() => {
    ...
    const fetchUserProfile = async () => {
      try {
        ...
        const response = await axios.get(`https://majorsssssss.onrender.com/users/profile/${rollno}`);
    ...
    const fetchExperiences = async () => {
      try {
        const response = await axios.get(`https://majorsssssss.onrender.com/experiences/experience/${currrollno}`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
    ...
    const fetchPlacementRecords = async () => {
      try {
        const response = await axios.get(`https://majorsssssss.onrender.com/placements/placementrecord/${currrollno}`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
