...
const CompanyQuestionsModal = ({ show, handleClose, company }) => {
  ...
  useEffect(() => {
    const fetchRecentQuestions = async () => {
      try {
        const technicalResponse = await axios.get(`https://majorsssssss.onrender.com/experiences/recent-technical-questions/${company}`);
        setTechnicalQuestions(technicalResponse.data);

        const hrResponse = await axios.get(`https://majorsssssss.onrender.com/experiences/recent-hr-questions/${company}`);
...
const SearchExperience = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`https://majorsssssss.onrender.com/experiences/experience`, {
          headers: {
        ...
        const companyNamesResponse = await axios.get(`https://majorsssssss.onrender.com/experiences/experience`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
        //const coresponse = await axios.get('https://majorsssssss.onrender.com/experiences');
        const companyNames = [...new Set(companyNamesResponse.data.map((experience) => experience.company_name))];
        setCompanyNames(companyNames);
         console.log("company names : ", companyNames);
        const yearsResponse = await axios.get(`https://majorsssssss.onrender.com/experiences/years`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
        ...
        const rolesResponse = await axios.get(`https://majorsssssss.onrender.com/experiences/roles`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
  ...
  const handleSearch = async (event) => {
    ...
    try {
      ...
      const response = await axios.get(`https://majorsssssss.onrender.com/experiences/search`, {
        params: {
          query,
          filters,
          sortBy,
