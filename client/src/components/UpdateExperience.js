...
const UpdateExperience = (props) => {
  ...
  useEffect(() => {
    const fetchExperience = async () => {
      try {
        const response = await axios.get(`https://majorsssssss.onrender.com/experiences/getexperience/${id}`, {
          headers: {
  ...
  const handleSaveChanges = async (e) => {
    ...
    try {
      const response = await axios.put(`https://majorsssssss.onrender.com/experiences/experiences/${id}`, updatedData, config);
